...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    a: "Common signs are high energy bills, rooms that are always too hot or too cold, drafts, and an HVAC system that never stops running. If your attic insulation is thin, settled, or you can see the ceiling joists, you're likely below modern standards. We'll take a look and tell you honestly.",
  },
  {
  ...
  },
  {
    ...
    a: "We're based in Yuba City and serve Marysville, Sutter County, and up the corridor to Grass Valley, Auburn, Truckee, and the Lake Tahoe area. If you're not sure whether you're in our area, just call and ask.",
  },
  {
    q: "How long does an insulation job take?",
    a: "Most residential attic jobs are completed in a single day. Larger homes, full removals, or whole-house projects may take longer. We'll give you a clear timeline as part of your estimate.",
  },
  {
    q: "Is the estimate really free?",
    a: "Yes. We'll assess your home, measure what's there, and give you a written estimate at no cost and with no obligation. We'd rather earn your trust than pressure you.",
  },
];
